export const hhColumns = [
  ...
  `15.1.1. What housing, land and properfty documents do you have?/Document issues by police\State Emergency Service proving that the house was damaged\destroyed – For Ukrainian state control areas`,
  ...
  `19.1.2. What factors are influencing the relationship with the host community ? /Language differrence`,
  ...
  `26.1.1. Where do you live now?/Rented house or apartment (with own means)`,
